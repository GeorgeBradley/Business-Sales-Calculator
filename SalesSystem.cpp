...
int main()
{
	bool bExitMainMenu = false;
	bool bExitProgram = false;
	bool bExitFileMenu = false;
	bool bLogout = false;
		...
		do 
		{
			...
			do
			{
				...
				if (Is_Input_A_Number(sMenuChoice, &iMenuChoice) == true) //Checks to ensure input is valid
				{
					...
					case 14:
						std::cout << "\n";
						std::cout << "You've chosen option 14.\n";
						bExitMainMenu = true;
						break;
